...
import {Input, message, Popover, Radio, Modal } from "antd";
import {
  ArrowDownOutlined,
  DownOutlined,
  SettingOutlined,
...
function Swap(props) {
  ...
  async function fetchDexSwap(){
    ...
    if(allowance.data.allowance === "0"){
      const approve = await axios.get(`https://api.1inch.io/v5.2/1/approve/transaction?tokenAddress=${tokenOne}`)
  ...
  return (
    ...
    <div className="tradeBox">
      ...
      <div className="inputs">
        <Input placeholder='0.0' value={tokenOneAmount} onChange={changeAmount} disabled={!prices}/>
        <Input placeholder='0.0' value={tokenTwoAmount} disabled={true} />
